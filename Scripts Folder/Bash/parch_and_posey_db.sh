...
cd /c/Users/Promi/Downloads
mkdir -p "parch_and_posey_unzipped"
unzip -q "wetransfer_parch_posey_data_2024-08-28_2103.zip" -d "parch_and_posey_unzipped"

# List the contents of the unzipped folder
echo "Contents of the unzipped folder:"
ls "parch_and_posey_unzipped"

# Define environmental variables
CSV_DIR="C:\Users\Promi\Downloads\parch_and_posey_unzipped"
DB_USER="postgres"
DB_NAME="posey"
